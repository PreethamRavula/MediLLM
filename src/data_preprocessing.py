...
# It loads a CSV file containing EMR records, tokenizes the text using a clinical BERT tokenizer,
# and preprocesses images for further analysis.
...
if __name__ == "__main__":
    ...
    df['image_path'] = df['image_path'].apply(lambda p: os.path.join(base_dir, p)) # apply function applies to each row in the 'image_path' column and joins the base directory with the relative path
    print("Sample record:") 
    print(df.iloc[0])
